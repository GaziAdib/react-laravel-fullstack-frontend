    ...
    render() {
        return (
            <Fragment>
                ...
                <Navbar.Brand className={this.state.navBarTitle}><NavLink className={this.state.navBarTitle} to="/"><img src={this.state.navBarLogo}/> Gazi Adib</NavLink></Navbar.Brand>
